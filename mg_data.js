...
// ── TIERS
const MG_TIERS = [
  { name:'Bronze',    min:0,     max:999,   dot:'#cd7f32', color:'#cd7f32',
    perks:['1 Boîte de munitions offerte à chaque achat'] },
  { name:'Argent',    min:1000,  max:4999,   dot:'#a8a9ad', color:'#a8a9ad',
    perks:['3 Boîtes de munitions offertes à chaque achat','Avantages Bronze inclus'] },
  { name:'Or',        min:5000,  max:9999,  dot:'#c8a84b', color:'#c8a84b',
    perks:['Achat gilet = second offert','Avantages Bronze & Argent inclus'] },
  { name:'Platinium', min:10000, max:999999, dot:'#a0b2c8', color:'#a0b2c8',
    perks:['1 Arme de poing offerte/mois','Tous les avantages précédents inclus'] },
];
